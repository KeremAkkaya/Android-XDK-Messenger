...
public class PushNotificationReceiver extends BroadcastReceiver {
    ...
    public static class Notifications {
        ...
        public Notifications(Context context) {
            ...
            mChannelId = context.getString(R.string.channel_id_messages);

            if (mManager != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                // Create the NotificationChannel
                CharSequence name = context.getString(R.string.channel_name_messages);
                String description = context.getString(R.string.channel_description_messages);
